...
And I have created the maximum amount of rules allowed
When I create another condition
And I create another action
And I create another rule
...
| dec_name       | condition_response_code  | action_response_code    |  rule_response_code |
| "RobSab01"     |     404                  |           400           |         400         |
| "RobSab02"     |     404                  |           400           |         400         |
| "RobSab03"     |     404                  |           400           |         400         |
