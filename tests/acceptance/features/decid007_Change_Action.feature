@ChangeActionFeature
 ...
 And I have added an action of type <old_action_type> named <old_action_name> to decision table with id <dec_tag> 
 ...
 Examples:
 | dec_name   | dec_tag |  old_action_type | old_action_name    | new_action_type   | new_value_list | new_action_name    |  action_response_code |
 | "RobSab01" | "dt_1"  |      boolean     | "boolean_action_1" |      text         |  "string_value"| "text_action_1"    |          200          |
 | "RobSab02" | "dt_2"  |      text        | "text_action_2"    |     boolean       |   ["A", "B"]   | "boolean_action_2" |          200          | 
