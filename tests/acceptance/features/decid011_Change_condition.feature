...
| dec_name       | dec_note          | dec_tag | con_name   | con_type   | con_vals                         | new_con_name   | new _con_type   | new_con_vals                         | con_response_code | Comment             |
| "RobSab01"     | "NoteRS01"        | "dt_1"  | "Region"   | "text"     | "Domestic,International"         | "Region"	     |"text"	       |"International"			      | 200               | same name, same type|
| "RobSab01"     | "NoteRS01"        | "dt_1"  | "Ship"     | "boolean"  | "Go,No Go"                       | "Shipping"     |"boolean"        |"ship, no ship"			      | 200               | same type		|
| "RobSab03"     | "NoteRS01"        | "dt_3"  | "Weight"   | "numeric"  | "<0,2>"                          | "Weight"       | "numeric"       | "<0,2>"                      	      | 200               | no change 		|
...
| dec_name       | dec_note          | dec_tag | con_name   | con_type   | con_vals                         | new_con_name   | new _con_type   | new_con_vals                         | con_response_code | <dec_msg>             			    	                 |
