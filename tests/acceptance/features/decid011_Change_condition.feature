...
| dec_name       | dec_note          | dec_tag |con_id   | con_name   | con_type   | con_vals                         | new_con_name   | new_con_type   | new_con_vals                         | con_response_code | Comment             |
| "RobSab01"     | "NoteRS01"        | "dt_1"  |"cn_1"   | "Region"   | "text"     | "Domestic,International"         | "Region"	   |"text"	         |"International"			            | 200               | same name, same type|
| "RobSab01"     | "NoteRS01"        | "dt_2"  |"cn_2"   | "Ship"     | "boolean"  | "Go,No Go"                       | "Shipping"     |"boolean"        |"ship, no ship"			            | 200               | same type		      |
...
| dec_name       | dec_note          | dec_tag |con_id | con_name   | con_type   | con_vals                         | new_con_name   | new_con_type   | new_con_vals                         | con_response_code | dec_msg             			    	                 |
| "RobSab01"     | "NoteRS01"        | "dt_4"  |"cn_1" | "Region"   | "text"	 | "Domestic,International"         | "Region"	     |"random"	       |"International"			              | 500 		      | "Inavlid type. Must be one of: boolean, text, numeric"   |
| "RobSab01"     | "NoteRS01"        | "dt_5"  |"cn_2" | "Ship"     | "boolean"  | "Go,No Go"                       | "Ship"         |"boolean"        |"ship, no ship, maybe ship"	          | 500               | "Invalid values for specified type"	 	    	         |
