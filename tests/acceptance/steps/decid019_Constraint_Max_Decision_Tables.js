...
When('I create Decision Tables over the specified number in the configuration file', async function () {
    // config file path
    let maxTables = data.maxTables;
    let tablesToCreate = maxTables + 1;
...
Then('the total number of tables created do not exceed the specified number in the configuration file', async function () {
